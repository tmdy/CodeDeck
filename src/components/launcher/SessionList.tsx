      ...
      <div className="session-toolbar">
        <div className="session-list-header">
          <div>
            ...
            {catalogState !== "ready" && (
              <p className="muted session-catalog-status">
          ...
          {showRefresh && (
            <button
              ...
              aria-label={isRefreshing ? "正在刷新会话" : undefined}
            >
              {isRefreshing
          ...
          {selectedSession ? (
            <>
              <div className="session-detail-card">
                ...
                {selectedSession.conversation_excerpts?.length ? (
                  <div className="session-picker-excerpts">
                    <p className="session-picker-heading">开头问答</p>
                    <ul className="session-picker-excerpt-list">
                      {selectedSession.conversation_excerpts.slice(0, 6).map((excerpt, index) => (
                        <li key={`${getSessionKey(selectedSession)}-excerpt-${index}`}>
