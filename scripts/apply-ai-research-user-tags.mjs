...
import { CodeDeckSkillsService, resolveDefaultPaths } from "../dist-electron/src/shared/skills-service.js";
...
async function main() {
  const service = new CodeDeckSkillsService(resolveDefaultPaths(projectRoot));
